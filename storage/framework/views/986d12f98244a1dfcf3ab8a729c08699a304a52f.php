...
<?php endif; ?>
                            ...
                            <table class="table table-hover table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">
                                            ...
                                            <span wire:click="sortBy('texto')" class="float-right text-sm" style="cursor: pointer;">
                                                <i class="fa fa-arrow-up <?php echo e($sortColumnName === 'texto' && $sortDirection === 'asc' ? '' : 'text-muted'); ?>"></i>
                                                <i class="fa fa-arrow-down <?php echo e($sortColumnName === 'texto' && $sortDirection === 'desc' ? '' : 'text-muted'); ?>"></i>
                                            </span>
                                        </th>
                                        <th>Ruta</th>
                                        <th>Posición</th>
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                            
                                            <a href="" wire:click.prevent="edit(<?php echo e($menu); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmMenuRemoval(<?php echo e($menu->id); ?>)">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="<?php echo e($showEditModal ? 'updateMenu' : 'createMenu'); ?>">
                <div class="modal-content">
                    ...
                    <div class="modal-body">                        
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="state.texto" class="form-control <?php $__errorArgs = ['texto'];
...
unset($__errorArgs, $__bag); ?>" id="texto" aria-describedby="textoHelp" placeholder="Introduzca la Texto">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="state.ruta" class="form-control <?php $__errorArgs = ['ruta'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="ruta" aria-describedby="rutaHelp" placeholder="Introduzca la Ruta">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="state.posicion" class="form-control <?php $__errorArgs = ['posicion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="posicion" aria-describedby="rutaHelp" placeholder="Introduzca la Posición">
...
<?php /**PATH C:\Users\Personal\Documents\Proyectos\github\repuestoexpres\resources\views/livewire/afiliado/repuestoexpres/list-menus.blade.php ENDPATH**/ ?>