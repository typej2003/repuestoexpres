...
<?php endif; ?>
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo e($manufacturers->firstItem() + $index); ?></th>
                                        <td>
                                            <img src="<?php echo e($manufacturer->avatar_url); ?>" style="width: 50px;" class="img img-circle mr-1" alt="">
                                        ...
                                        <td><?php echo e($manufacturer->created_at->toFormattedDate() ?? 'N/A'); ?></td>
                                        <td>
                                            
                                            <a href="" wire:click.prevent="edit(<?php echo e($manufacturer); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmManufacturerRemoval(<?php echo e($manufacturer->id); ?>)">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="<?php echo e($showEditModal ? 'updateManufacturer' : 'createManufacturer'); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select wire:model.defer="state.mercado" class="form-control <?php $__errorArgs = ['mercado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="mercado">
                                <option value="original">Original</option>
                                <option value="generico">Generico</option>
                            </select>
                            <?php $__errorArgs = ['mercado'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea wire:model.defer="state.address" class="form-control <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="address" aria-describedby="addressHelp" placeholder="Introduzca la Dirección"></textarea>
...
<?php /**PATH C:\Users\Personal\Documents\Proyectos\github\repuestoexpres\resources\views/livewire/afiliado/list-manufacturers.blade.php ENDPATH**/ ?>