                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($user->created_at->toFormattedDate() ?? 'N/A'); ?></td>
                                        <td>
                                            <select class="form-control" wire:change="changeRole(<?php echo e($user); ?>, $event.target.value)">
                                                ...
                                                <option value="user" <?php echo e(($user->role === 'cliente') ? 'selected' : ''); ?>>CLIENTE</option>
                                                <option value="afiliado" <?php echo e(($user->role === 'afiliado') ? 'selected' : ''); ?>>AFILIADO</option>
                                            </select>
                                        </td>
                                        <td>
                                            <a href="/listComercios/<?php echo e($user->id); ?>">
...
<?php /**PATH C:\Users\Personal\Documents\Proyectos\repuestos\resources\views/livewire/admin/users/list-users.blade.php ENDPATH**/ ?>