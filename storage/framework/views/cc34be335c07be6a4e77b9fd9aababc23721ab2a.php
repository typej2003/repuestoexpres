...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="state.descripcion" class="form-control <?php $__errorArgs = ['descripcion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="descripcion" aria-describedby="descripcionpagoHelp" placeholder="Introduzca la Descripcion">
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/livewire/admin/settings/list-metodos-pagos.blade.php ENDPATH**/ ?>