            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="/listCategories/<?php echo e($comercio->user_id); ?>">Categorias</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<?php endif; ?>
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    <?php $__empty_1 = true; $__currentLoopData = $subcategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $subcategoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <th scope="row"><?php echo e($subcategories->firstItem() + $index); ?></th>
                                        <td>
                                            <img src="<?php echo e($subcategoria->avatar_url); ?>" style="width: 50px;" class="img img-circle mr-1" alt="">
                                            <?php echo e($subcategoria->name); ?>

                                        </td>
                                        <td><?php echo e($subcategoria->categoria->name); ?></td>
                                        <td>
                                            <select class="form-control" wire:change="changeMenu(<?php echo e($subcategoria); ?>, $event.target.value)">
                                                <option value="0" <?php echo e(($subcategoria->itemMenu === '0') ? 'selected' : ''); ?>>NO</option>
                                                <option value="1" <?php echo e(($subcategoria->itemMenu === '1') ? 'selected' : ''); ?>>SI</option>
                                            </select>
                                        </td>
                                        <td><?php echo e($subcategoria->created_at->toFormattedDate() ?? 'N/A'); ?></td>
                                        <td>
                                            
                                            <a href="" wire:click.prevent="edit(<?php echo e($subcategoria); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmSubcategoryRemoval(<?php echo e($subcategoria->id); ?>)">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="<?php echo e($showEditModal ? 'updateSubcategory' : 'createSubcategory'); ?>">
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/livewire/afiliado/list-subcategories.blade.php ENDPATH**/ ?>