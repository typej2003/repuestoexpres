...
} elseif ($_instance->childHasBeenRendered('gXJ2AJv')) {
    $componentId = $_instance->getRenderedChildComponentId('gXJ2AJv');
    $componentTag = $_instance->getRenderedChildComponentTagName('gXJ2AJv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gXJ2AJv');
} else {
    $response = \Livewire\Livewire::mount('layouts.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('gXJ2AJv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    ...
    <section class="">
        <div class="row">
            ...
            <div class="my-2"></div>
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.repuestoexpres.list-masdestacado')->html();
} elseif ($_instance->childHasBeenRendered('wsYe3hX')) {
    $componentId = $_instance->getRenderedChildComponentId('wsYe3hX');
    $componentTag = $_instance->getRenderedChildComponentTagName('wsYe3hX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wsYe3hX');
} else {
    $response = \Livewire\Livewire::mount('components.repuestoexpres.list-masdestacado');
    $html = $response->html();
    $_instance->logRenderedChild('wsYe3hX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <div class="my-2"></div>
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('components.results-products', ['parametro' => $parametro])->html();
} elseif ($_instance->childHasBeenRendered('xULtLgo')) {
    $componentId = $_instance->getRenderedChildComponentId('xULtLgo');
    $componentTag = $_instance->getRenderedChildComponentTagName('xULtLgo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xULtLgo');
} else {
    $response = \Livewire\Livewire::mount('components.results-products', ['parametro' => $parametro]);
    $html = $response->html();
    $_instance->logRenderedChild('xULtLgo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>        
            </div>
...
<?php /**PATH C:\Users\Personal\Documents\Proyectos\github\repuestoexpres\resources\views/MainSearch.blade.php ENDPATH**/ ?>