...
<?php endif; ?>
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered table-responsive">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo e($areas->firstItem() + $index); ?></th>
                                        <td>
                                            <?php echo e($area->name); ?>

                                        </td>
                                        <td><?php echo e($area->CantComercio()); ?></td>
                                        <td><?php echo e($area->created_at ?? 'N/A'); ?></td>
                                        <td>
                                            
                                            <a href="" wire:click.prevent="edit(<?php echo e($area); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmAreaRemoval(<?php echo e($area->id); ?>)">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="<?php echo e($showEditModal ? 'updateArea' : 'createArea'); ?>">
...
<?php /**PATH C:\Users\Personal\Documents\Proyectos\github\repuestoexpres\resources\views/livewire/admin/settings/list-areas.blade.php ENDPATH**/ ?>