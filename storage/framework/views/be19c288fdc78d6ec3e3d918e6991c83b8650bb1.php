...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('iEmF5Jt')) {
    $componentId = $_instance->getRenderedChildComponentId('iEmF5Jt');
    $componentTag = $_instance->getRenderedChildComponentTagName('iEmF5Jt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iEmF5Jt');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('iEmF5Jt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
