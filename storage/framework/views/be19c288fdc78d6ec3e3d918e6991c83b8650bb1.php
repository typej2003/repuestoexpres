...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('j7TCVcp')) {
    $componentId = $_instance->getRenderedChildComponentId('j7TCVcp');
    $componentTag = $_instance->getRenderedChildComponentTagName('j7TCVcp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('j7TCVcp');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('j7TCVcp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('78d4QKF')) {
    $componentId = $_instance->getRenderedChildComponentId('78d4QKF');
    $componentTag = $_instance->getRenderedChildComponentTagName('78d4QKF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('78d4QKF');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('78d4QKF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
    ...
    </div><?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/livewire/afiliado/view-details.blade.php ENDPATH**/ ?>