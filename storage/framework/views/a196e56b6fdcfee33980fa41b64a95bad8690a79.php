                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" wire:change="changeConfirmation(<?php echo e($pedido); ?>, $event.target.value)">
                                                ...
                                                <option value="delivered" <?php echo e(($pedido->pedidoentregado === 'delivered') ? 'selected' : ''); ?>>ENTREGADO</option>
                                                <option value="notdelivered" <?php echo e(($pedido->pedidoentregado === 'notdelivered') ? 'selected' : ''); ?>>NO ENTREGADO</option>
                                            </select>
                                        </td>
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/livewire/afiliado/list-pedidos-delivery.blade.php ENDPATH**/ ?>