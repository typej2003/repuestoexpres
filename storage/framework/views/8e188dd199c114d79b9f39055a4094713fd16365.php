                        ...
                        <div>
                            <div class="card showProductCard mx-auto text-center">
                                <card-body>
                                    ...
                                    <div class="row">
                                    <div class="negrita textProductOffer" style="margin-left: 10px;"><?php echo e($offer->name); ?></div>
                                        <div class="textProductOffer text-decoration-line-through">Precio: USD. <?php echo e($offer->price1); ?></div>
                                        <div class="textProductOffer">Promoción: USD. <?php echo e($offer->price_offer); ?></div>
...
</section>   --><?php /**PATH C:\Users\Personal\Documents\Proyectos\github\repuestoexpres\resources\views/livewire/components/carousel-offer.blade.php ENDPATH**/ ?>