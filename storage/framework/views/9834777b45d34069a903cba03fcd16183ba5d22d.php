...
} elseif ($_instance->childHasBeenRendered('F8rmIxg')) {
    $componentId = $_instance->getRenderedChildComponentId('F8rmIxg');
    $componentTag = $_instance->getRenderedChildComponentTagName('F8rmIxg');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F8rmIxg');
} else {
    $response = \Livewire\Livewire::mount('layouts.navbar');
    $html = $response->html();
    $_instance->logRenderedChild('F8rmIxg', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('qlsRGXq')) {
    $componentId = $_instance->getRenderedChildComponentId('qlsRGXq');
    $componentTag = $_instance->getRenderedChildComponentTagName('qlsRGXq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qlsRGXq');
} else {
    $response = \Livewire\Livewire::mount('components.carousel-offer');
    $html = $response->html();
    $_instance->logRenderedChild('qlsRGXq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <div class="my-2"></div>
...
} elseif ($_instance->childHasBeenRendered('yDCQpUu')) {
    $componentId = $_instance->getRenderedChildComponentId('yDCQpUu');
    $componentTag = $_instance->getRenderedChildComponentTagName('yDCQpUu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yDCQpUu');
} else {
    $response = \Livewire\Livewire::mount('components.show-products');
    $html = $response->html();
    $_instance->logRenderedChild('yDCQpUu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <div class="my-5"></div>
...
<?php /**PATH C:\Users\Personal\Documents\Proyectos\repuestos\resources\views/welcome.blade.php ENDPATH**/ ?>