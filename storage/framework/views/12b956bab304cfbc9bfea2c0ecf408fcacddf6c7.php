<div>
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Usuarios para comercio: <?php echo e($comercio->name); ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="<?php echo e($user->user->avatar_url); ?>" style="width: 50px;" class="img img-circle mr-1" alt="">
                                        ...
                                        <td>
                                            <select class="form-control" wire:change="changeRole(<?php echo e($user); ?>, $event.target.value)">
                                                <option value="delivery" <?php echo e(($user->rolecomercio === 'admin') ? 'selected' : ''); ?>>Delivery</option>
                                            </select>
                                        </td>
                                        <td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <select name="" wire:model.defer="state.role" class="roleS form-control <?php $__errorArgs = ['role'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group d-none vehiculo">
                            ...
                            <select name="" wire:model.defer="state.vehiculo" class="form-control <?php $__errorArgs = ['vehiculo'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="names" aria-describedby="namesHelp" placeholder="Nombres completo">
...
unset($__errorArgs, $__bag); ?>" id="surnames" aria-describedby="namesHelp" placeholder="Nombres completo">
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/livewire/afiliado/repuestoexpres/list-users-comercio.blade.php ENDPATH**/ ?>