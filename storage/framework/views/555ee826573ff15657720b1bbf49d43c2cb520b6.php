...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('gj8jn1Z')) {
    $componentId = $_instance->getRenderedChildComponentId('gj8jn1Z');
    $componentTag = $_instance->getRenderedChildComponentTagName('gj8jn1Z');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gj8jn1Z');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('gj8jn1Z', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('ohBh9rA')) {
    $componentId = $_instance->getRenderedChildComponentId('ohBh9rA');
    $componentTag = $_instance->getRenderedChildComponentTagName('ohBh9rA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ohBh9rA');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('ohBh9rA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('HttGHN0')) {
    $componentId = $_instance->getRenderedChildComponentId('HttGHN0');
    $componentTag = $_instance->getRenderedChildComponentTagName('HttGHN0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HttGHN0');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('HttGHN0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
