...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('vmUMhtM')) {
    $componentId = $_instance->getRenderedChildComponentId('vmUMhtM');
    $componentTag = $_instance->getRenderedChildComponentTagName('vmUMhtM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vmUMhtM');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('vmUMhtM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('RiYyOUu')) {
    $componentId = $_instance->getRenderedChildComponentId('RiYyOUu');
    $componentTag = $_instance->getRenderedChildComponentTagName('RiYyOUu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RiYyOUu');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('RiYyOUu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('o06LE0j')) {
    $componentId = $_instance->getRenderedChildComponentId('o06LE0j');
    $componentTag = $_instance->getRenderedChildComponentTagName('o06LE0j');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('o06LE0j');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('o06LE0j', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
