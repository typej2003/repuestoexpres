...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('tNwU2Nv')) {
    $componentId = $_instance->getRenderedChildComponentId('tNwU2Nv');
    $componentTag = $_instance->getRenderedChildComponentTagName('tNwU2Nv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tNwU2Nv');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('tNwU2Nv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('kMTDcGJ')) {
    $componentId = $_instance->getRenderedChildComponentId('kMTDcGJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('kMTDcGJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kMTDcGJ');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('kMTDcGJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('iGCGABs')) {
    $componentId = $_instance->getRenderedChildComponentId('iGCGABs');
    $componentTag = $_instance->getRenderedChildComponentTagName('iGCGABs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iGCGABs');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('iGCGABs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/externalviews/view-details.blade.php ENDPATH**/ ?>