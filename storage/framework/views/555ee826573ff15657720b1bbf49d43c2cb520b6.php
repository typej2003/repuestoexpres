...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('HOhm47m')) {
    $componentId = $_instance->getRenderedChildComponentId('HOhm47m');
    $componentTag = $_instance->getRenderedChildComponentTagName('HOhm47m');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HOhm47m');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('HOhm47m', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('xE1Smca')) {
    $componentId = $_instance->getRenderedChildComponentId('xE1Smca');
    $componentTag = $_instance->getRenderedChildComponentTagName('xE1Smca');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xE1Smca');
} else {
    $response = \Livewire\Livewire::mount('afiliado.view-details', [
                        'productId' => $productId
                    ]);
    $html = $response->html();
    $_instance->logRenderedChild('xE1Smca', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('VEPEmFR')) {
    $componentId = $_instance->getRenderedChildComponentId('VEPEmFR');
    $componentTag = $_instance->getRenderedChildComponentTagName('VEPEmFR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VEPEmFR');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('VEPEmFR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
