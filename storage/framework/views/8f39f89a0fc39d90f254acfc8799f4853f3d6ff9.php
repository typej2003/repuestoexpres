...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('ta62LTB')) {
    $componentId = $_instance->getRenderedChildComponentId('ta62LTB');
    $componentTag = $_instance->getRenderedChildComponentTagName('ta62LTB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ta62LTB');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('ta62LTB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('1fiJqUf')) {
    $componentId = $_instance->getRenderedChildComponentId('1fiJqUf');
    $componentTag = $_instance->getRenderedChildComponentTagName('1fiJqUf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1fiJqUf');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('1fiJqUf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('1yWHkbr')) {
    $componentId = $_instance->getRenderedChildComponentId('1yWHkbr');
    $componentTag = $_instance->getRenderedChildComponentTagName('1yWHkbr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1yWHkbr');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('1yWHkbr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
