...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('ds7yXp6')) {
    $componentId = $_instance->getRenderedChildComponentId('ds7yXp6');
    $componentTag = $_instance->getRenderedChildComponentTagName('ds7yXp6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ds7yXp6');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('ds7yXp6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('0iL4ELE')) {
    $componentId = $_instance->getRenderedChildComponentId('0iL4ELE');
    $componentTag = $_instance->getRenderedChildComponentTagName('0iL4ELE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0iL4ELE');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('0iL4ELE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('Q8GuHdn')) {
    $componentId = $_instance->getRenderedChildComponentId('Q8GuHdn');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q8GuHdn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q8GuHdn');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('Q8GuHdn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
