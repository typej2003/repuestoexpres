...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('nAhdubr')) {
    $componentId = $_instance->getRenderedChildComponentId('nAhdubr');
    $componentTag = $_instance->getRenderedChildComponentTagName('nAhdubr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nAhdubr');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('nAhdubr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('MZevXFQ')) {
    $componentId = $_instance->getRenderedChildComponentId('MZevXFQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('MZevXFQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MZevXFQ');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('MZevXFQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('npBNklj')) {
    $componentId = $_instance->getRenderedChildComponentId('npBNklj');
    $componentTag = $_instance->getRenderedChildComponentTagName('npBNklj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('npBNklj');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('npBNklj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/cart/cart.blade.php ENDPATH**/ ?>