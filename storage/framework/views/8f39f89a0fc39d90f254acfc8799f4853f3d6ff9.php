...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('3BJkjrO')) {
    $componentId = $_instance->getRenderedChildComponentId('3BJkjrO');
    $componentTag = $_instance->getRenderedChildComponentTagName('3BJkjrO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3BJkjrO');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('3BJkjrO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <div class="wrapper">
...
} elseif ($_instance->childHasBeenRendered('sTPNJjR')) {
    $componentId = $_instance->getRenderedChildComponentId('sTPNJjR');
    $componentTag = $_instance->getRenderedChildComponentTagName('sTPNJjR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sTPNJjR');
} else {
    $response = \Livewire\Livewire::mount('cart.cart1');
    $html = $response->html();
    $_instance->logRenderedChild('sTPNJjR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('crlhDTh')) {
    $componentId = $_instance->getRenderedChildComponentId('crlhDTh');
    $componentTag = $_instance->getRenderedChildComponentTagName('crlhDTh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('crlhDTh');
} else {
    $response = \Livewire\Livewire::mount('layouts.footer', [
                'comercioId' => 1,
                ]);
    $html = $response->html();
    $_instance->logRenderedChild('crlhDTh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
