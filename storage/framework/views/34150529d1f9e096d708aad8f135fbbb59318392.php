...
<?php endif; ?>
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody wire:loading.class="text-muted">
                                    <?php $__empty_1 = true; $__currentLoopData = $impuestos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $impuesto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <th scope="row"><?php echo e($impuestos->firstItem() + $index); ?></th>
                                        <td><?php echo e($impuesto->comercio_id); ?></td>
                                        <td><?php echo e($impuesto->name); ?></td>
                                        <td><?php echo e($impuesto->amount); ?></td>
                                        <td><?php echo e($impuesto->created_at->toFormattedDate() ?? 'N/A'); ?></td>
                                        <td>                                            
                                            <a href="" wire:click.prevent="edit(<?php echo e($impuesto); ?>)">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmImpuestoRemoval(<?php echo e($impuesto->id); ?>)">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="<?php echo e($showEditModal ? 'updateImpuesto' : 'createImpuesto'); ?>">
...
unset($__errorArgs, $__bag); ?>" id="name" aria-describedby="nameHelp" placeholder="Impuesto">
...
unset($__errorArgs, $__bag); ?>" id="amount" aria-describedby="nameHelp" placeholder="Valor">
...
<?php /**PATH C:\Users\typej\Documents\git\repuestoexpres\resources\views/livewire/afiliado/repuestoexpres/list-impuestos.blade.php ENDPATH**/ ?>