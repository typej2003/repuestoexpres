  ...
  <body class="">
   <!--ENCABEZADO--> 
    ...
    <section class="body">
        <!--ENCABEZADO --> 
        <div class="my-2"></div>
        @include('livewire.components.marcas-productos')    
        <div class="my-2"></div>
        @include('livewire.components.carousel-offer')    
        <div class="my-2"></div>
        @include('livewire.components.show-products')
    </section>
                        ...
                        <div class="form-group">
                            <div class="row mx-auto" >
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <input type="email" name="email" class="form-control inputForm" placeholder="Correo Electrónico" id="email" autocomplete="off">
                                </div>
                            </div>
                            @error('email')
